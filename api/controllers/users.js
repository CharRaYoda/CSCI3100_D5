...
export const addUser = (req, res) => {
    ...
    const q = "INSERT INTO users(`uid`,`password`,`email`,`role`,`gpa`,`name`) VALUES (?)";
    const values = [req.body.uid, req.body.password, req.body.email, req.body.role, req.body.gpa, req.body.username];
